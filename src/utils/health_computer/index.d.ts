...
* @returns {string}
*/
export function max_borrow_estimate_js(c: HealthComputer, borrow_denom: string, target: BorrowTarget): string;
/**
* @param {HealthComputer} c
...
* @returns {string}
*/
export function max_swap_estimate_js(c: HealthComputer, from_denom: string, to_denom: string, kind: SwapKind, slippage: Number, is_repaying_debt: boolean): string;
/**
* @param {HealthComputer} c
* @param {string} denom
...
* @returns {string}
*/
export function liquidation_price_js(c: HealthComputer, denom: string, kind: LiquidationPriceKind): string;
/**
* @param {HealthComputer} c
* @param {string} denom
...
* @returns {string}
*/
export function max_perp_size_estimate_js(c: HealthComputer, denom: string, base_denom: string, long_oi_amount: Uint, short_oi_amount: Uint, direction: Direction): string;
...
export type BorrowTarget = "deposit" | "wallet" | { vault: { address: Addr } } | { swap: { denom_out: string; slippage: Decimal } };
...
export interface InitOutput {
  ...
  readonly max_swap_estimate_js: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  readonly liquidation_price_js: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly max_perp_size_estimate_js: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;

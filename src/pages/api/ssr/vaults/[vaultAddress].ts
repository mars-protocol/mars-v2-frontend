    ...
    const html = `
      ...
      <html lang="en">
        <head>
          ...
          <title>${title}</title>
          <meta property="og:url" content="${baseUrl}/vaults/${vault.vault_address}/details" />
          <meta property="og:title" content="${title}" />
          <meta property="og:description" content="${description}" />
          <meta property="og:image" content="${baseUrl}/api/og/${vault.vault_address}/${unixTime}" />
          <meta property="twitter:title" content="${title}" />
          <meta property="twitter:description" content="${description}" />
          <meta property="twitter:image" content="${baseUrl}/api/og/${vault.vault_address}/${unixTime}" />

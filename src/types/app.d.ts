...
declare global {
  ...
  type AccountKind =
    import('types/generated/mars-credit-manager/MarsCreditManager.types').AccountKind
  ...
  interface BroadcastSlice {
    ...
    changeHlsStakingLeverage: (options: {
      accountId: string
      actions: Action[]
    }) => Promise<boolean>
  ...
  interface BridgeRowProps<T extends BridgeRowData> {
    row: TanstackRow<T>

...
export default function UnlockVaultModalContent(props: Props) {
  function onConfirm() {}
  return (
    <>
      <Text size='xl'>Are you sure you would like to unlock this position?</Text>
      <Text className='mt-2 text-white/60'>
        {`Are you sure you want to unlock this position? The unlocking period will take ${props.vault.lockup.duration} ${props.vault.lockup.timeframe}.`}
      </Text>

      ...
      <div className='relative mt-3'>
        <input
          ...
          className={classNames(
            'w-full px-4 py-3 outline-none border rounded-sm bg-white/5 border-white/10 text-sm focus:border-white/20 hover:cursor-pointer placeholder:text-white/60',
            suffix && 'pr-6',
          )}
        />
        {suffix && (

...
15.5,92.3 18.6,73.4 5,60 23.9,48.3 15.5,27.7 '
            ...
            <polygon
              className={classNames(
                !reduceMotion && 'opacity-0 animate-loaderGlow',
                'animate-delay-[5500ms]',
              )}
              fill='currentColor'

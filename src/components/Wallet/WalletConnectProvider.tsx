...
export const WalletConnectProvider: FC<Props> = ({ children }) => {
  ...
  return (
    <WalletManagerProvider
      ...
      classNames={{
        modalContent:
          'relative z-50 w-[640px] max-w-full rounded-md border border-white/20 bg-white/5 p-6 backdrop-blur-3xl flex flex-wrap',
        modalOverlay:
      ...
      closeIcon={<Button icon={<Close />} iconSize={2} color='tertiary' />}
      renderLoader={() => (
        <div>
